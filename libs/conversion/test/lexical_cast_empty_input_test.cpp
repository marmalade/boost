...
/*<boost.py:auto_insert>*/ namespace lexical_cast_empty_input_test_ns {/*<boost.py:auto_insert>*/
...
IW_TEST(lexical_cast_empty_input_test)
{
    iw_test_tree_visitor v;
    boost::unit_test::test_suite* suite = lexical_cast_empty_input_test_ns::init_unit_test_suite(0, NULL);
