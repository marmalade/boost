...
/*<boost.py:auto_insert>*/ namespace sp_recursive_assign_rv_test_ns {/*<boost.py:auto_insert>*/
...
IW_TEST(sp_recursive_assign_rv_test)
{
    sp_recursive_assign_rv_test_ns::main();
    return S3E_TRUE;
}
